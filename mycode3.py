...
def meriteam(team) :
    dimList=[team.getDimensionX(),team.getDimensionY()]
    return dimList
class abcd :
...
def spread(pirate):
    ...
    if t<150 or 500<=t<720 or 900<=t<1200 or 1500<=t<1800 or 2100<=t<2400 or 2700<=t<=3000 :
        if j == meriteam[0] and abcd.dir[0] == 1:  # If at rightmost edge and moving right
        ...
        if k == meriteam[1] and abcd.dir[0] == 1:  # If at rightmost edge and moving right
            abcd.dir[0] = -1  # Change direction to move left
           # print(t)
...
def ActPirate(pirate):
    ...
    if pirate.getTeamSignal() != "" and pirate.getCurrentFrame() > 1000:
